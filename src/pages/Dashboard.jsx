...
const QUICK_ACCESS_CONFIG = [
  ...
  },
  {
    ...
    group: "operations",
    searchTerms: ["all orders", "order queue", "kitchen orders"],
    path: "/tableoverview?tab=kitchen",
    color: "bg-gradient-to-r from-fuchsia-500 to-violet-600",
  ...
  {
    id: "pre-order",
    labelKey: "Tickets/Orders",
    defaultLabel: "Tickets/Orders",
    group: "operations",
  ...
  const groupedAccessSections = useMemo(() => {
    const sectionDefs = [
      ...
      },
      {
        ...
        tileClass: "bg-gradient-to-br from-slate-700 to-slate-900",
        ids: ["staff-checkin", "staff-schedule", "task", "user-management", "role-management", "add-new-user", "maintenance"],
      },
      {
        key: "inventory",
        title: t("Inventory"),
