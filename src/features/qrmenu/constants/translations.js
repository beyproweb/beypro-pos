const DICT = {
  en: {
    ...
    "Open this menu in Chrome, then tap Download App again.": "Open this menu in Chrome, then tap Download App again.",
    "Instagram browser cannot install the app. Open this menu in Chrome or Safari first.": "Instagram browser cannot install the app. Open this menu in Chrome or Safari first.",
    "Open this page in Safari, then add it to your Home Screen.": "Open this page in Safari, then add it to your Home Screen.",
    "Install this menu app in Chrome for the best experience.": "Install this menu app in Chrome for the best experience.",
    "Open this page in Chrome or Safari, then install it as an app.": "Open this page in Chrome or Safari, then install it as an app.",
  ...
  tr: {
    ...
    "Open in Chrome": "Chrome'da Aç",
    "Open in Safari": "Safari'de Aç",
    "Open this menu in Chrome, then tap Download App again.": "Bu menuyu Chrome'da acin, ardindan tekrar Uygulamayi Indir'e dokunun.",
    "Instagram browser cannot install the app. Open this menu in Chrome or Safari first.": "Instagram tarayicisi uygulamayi yukleyemez. Once bu menuyu Chrome veya Safari'de acin.",
    "Open this page in Safari, then add it to your Home Screen.": "Bu sayfayı Safari'de açın, ardından Ana Ekrana ekleyin.",
    "Install this menu app in Chrome for the best experience.": "En iyi deneyim için bu menü uygulamasını Chrome'da yükleyin.",
    "Open this page in Chrome or Safari, then install it as an app.": "Bu sayfayı Chrome veya Safari'de açın, ardından uygulama olarak yükleyin.",
  ...
  de: {
    ...
    "Open in Chrome": "In Chrome oeffnen",
    "Open in Safari": "In Safari oeffnen",
    "Open this menu in Chrome, then tap Download App again.": "Oeffnen Sie dieses Menue in Chrome und tippen Sie dann erneut auf App herunterladen.",
    "Instagram browser cannot install the app. Open this menu in Chrome or Safari first.": "Der Instagram-Browser kann die App nicht installieren. Oeffnen Sie dieses Menue zuerst in Chrome oder Safari.",
    "Open this page in Safari, then add it to your Home Screen.": "Öffnen Sie diese Seite in Safari und fügen Sie sie dann zum Startbildschirm hinzu.",
    "Install this menu app in Chrome for the best experience.": "Installieren Sie diese Menü-App in Chrome für das beste Erlebnis.",
    "Open this page in Chrome or Safari, then install it as an app.": "Öffnen Sie diese Seite in Chrome oder Safari und installieren Sie sie dann als App.",
  ...
  fr: {
    ...
    "Open this menu in Chrome, then tap Download App again.": "Ouvrez ce menu dans Chrome, puis appuyez a nouveau sur Telecharger l'application.",
    "Instagram browser cannot install the app. Open this menu in Chrome or Safari first.": "Le navigateur Instagram ne peut pas installer l'application. Ouvrez d'abord ce menu dans Chrome ou Safari.",
    "Open this page in Safari, then add it to your Home Screen.": "Ouvrez cette page dans Safari, puis ajoutez-la à votre écran d'accueil.",
    "Install this menu app in Chrome for the best experience.": "Installez cette application de menu dans Chrome pour une meilleure expérience.",
    "Open this page in Chrome or Safari, then install it as an app.": "Ouvrez cette page dans Chrome ou Safari, puis installez-la comme application.",
