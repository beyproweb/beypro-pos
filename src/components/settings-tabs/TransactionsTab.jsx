    ...
    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow p-6 max-w-4xl mx-auto text-gray-900 dark:text-white space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <label className="flex items-start gap-3 p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
          <input
            type="checkbox"
            checked={!!settings.disableTableOverviewGuestsFloatingButton}
            onChange={() => toggle("disableTableOverviewGuestsFloatingButton")}
            className="mt-1 h-5 w-5 accent-indigo-500"
          />
          <div>
            <div className="font-semibold text-sm">
              {t("Disable floating Guests counter in Table Overview")}
            </div>
            <div className="text-xs text-slate-500">
              {t("Hides the floating guests counter in the Table Overview screen.")}
            </div>
          </div>
        </label>
        ...
        <label className="flex items-start gap-3 p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
          ...
          <div>
            <div className="font-semibold text-sm">
              {t("Require seat selection when opening a table")}
            </div>
            <div className="text-xs text-slate-500">
              {t("Prevent opening a table unless the number of guests/seats is set via Table Overview")}
            </div>
          </div>
        </label>
      </div>
